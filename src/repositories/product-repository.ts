...
export class ProductRepository extends Repository {
    ...
    public checkCodeGeneratorRule = (): Observable<boolean> => {
        return this.httpObservable.post<boolean>(kebabCase(nameof(this.checkCodeGeneratorRule)),)
    ...
    public getProductHistory = (item: any): Observable<any> => {
        return this.httpObservable.post<Product>
            (kebabCase(nameof(this.getProductHistory)), { item })
            .pipe(map((response: AxiosResponse<Product>) => response.data));
    };

    
    public saveImage = (file: any, params?: { [key: string]: any }): Observable<any> => {
        const formData: FormData = new FormData();
    ...
    public saveItemImage = (file: any, params?: { [key: string]: any }): Observable<any> => {
        const formData: FormData = new FormData();
        formData.append('file', file);
        return this.httpObservable
            .post<void>(kebabCase(nameof(this.saveItemImage)), formData,
                {
                    headers: {
                        'Content-Type': 'application/x-www-form-urlencoded',
                    },
