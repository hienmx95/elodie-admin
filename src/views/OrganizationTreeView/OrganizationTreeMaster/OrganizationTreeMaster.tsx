...
function OrganizationTreeMaster() {
    ...
    const { validAction } = authenticationService.useAction('organization', API_ORGANIZATION_PREFIX);
                        ...
                        {isActive && (
                            <>
                                <Row className='mt-3 mb-3'>
                                    <Col span={6}>
                                        <AdvanceIdFilter
                                            onChange={handleChangeSearch('organizationTreeFilterType')}
                                            placeHolder={translate("organizations.placeholder.appUser")}
                                            title={translate("organizations.appUser")}
                                            classFilter={ModelFilter}
                                            isEnumList={true}
                                            getList={organizationRepository.singleListTreeSelectOption}
                                        />
                                    </Col>
                                    {validAction('exportAppUser') &&
                                        <Col className="mt-1">
                                            <button
                                                ...
                                                onClick={handleExportAppUser(appUserFilter, organizationRepository.exportAppUser)}
                                            >
