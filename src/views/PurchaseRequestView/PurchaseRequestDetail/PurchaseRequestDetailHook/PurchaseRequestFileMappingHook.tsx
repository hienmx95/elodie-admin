...
const antIcon = <LoadingOutlined style={{ fontSize: 24, color: "#3F8CFF" }} spin />;

export function usePurchaseRequestFileMapping(
...
export interface PurchaseRequestFileMappingModalProps {
  files?: FileModel[];
...
export function PurchaseRequestFileMappingModal(
  props: PurchaseRequestFileMappingModalProps
) {
  const {
    files,
    visibleDialog,
