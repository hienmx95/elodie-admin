...
export function usePurchaseRequestContentTable(
          ...
          return (
            <div className="table-cell__container">
              ...
              <div className="text-danger">
                {purchaseRequestContentContents[0]?.errors?.quantity}
              </div>
              ...
              <div className="text-danger">
                {purchaseRequestContentContents[0]?.errors?.unitOfMeasureId}
              </div>
            </div>
          );
        }),
            ...
            <div className="table-cell__container">
              ...
              <div className="table-cell__row">
                <div className="row__left">
                  <Select
                    ...
                    placeHolder={"Tiền tệ..."}
                    isMaterial={true}
                    getList={purchaseRequestRepository.singleListCurrency}
              ...
              <div className="result-cell">
                <span className="cell-number">
                  ...
                  {params[1].exchangeRate && <span>{model.mainCurrency?.code}</span>}
                </span>
              </div>
            </div>
          );
          ...
          return (
            <div className="table-cell__header">
              <Select
                ...
                isMaterial={true}
                placeHolder={"Thuế..."}
                getList={purchaseRequestRepository.singleListTaxType}
                onChange={handleChangeObjectField(
                  params[1],
