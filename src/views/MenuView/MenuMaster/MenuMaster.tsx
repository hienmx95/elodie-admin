...
function MenuMaster() {
    ...
    const {
        ...
        canBulkDelete,
        pagination
    } = masterService.useMaster<Menu, MenuFilter>
    (
        MenuFilter,
        '',
        menuRepository.list,
        ...
        <MenuAntd>
            ...
            <Tooltip title={translate("general.button.importExcel")}>
                ...
                <input
                    ...
                    style={ { display: "none" } }
                    id="master-import"
                    onChange={handleImportList(menuRepository.import)}
                />
                <button
            ...
            <Tooltip title={translate("general.button.exportExcel")}>
                <button
                className="btn border-less gradient-btn-icon grow-animate-2"
                onClick={handleListExport(filter, menuRepository.export)}
                >
            ...
            <Tooltip title={translate("general.button.downloadTemplate")}>
                <button
                className="btn border-less gradient-btn-icon grow-animate-2"
                onClick={handleExportTemplateList(menuRepository.exportTemplate)}
                >
    ...
    const menuAction = React.useCallback((id: number, menu: Menu) => (
        <MenuAntd>
            <MenuAntd.Item key="1">
            ...
            <MenuAntd.Item key="3">
                <Tooltip title={translate("general.actions.delete")}>
                    <button className="btn btn-sm component__btn-delete"
                            onClick={() => handleServerDelete(menu)}>
    ...
    const columns: ColumnProps<Menu>[] = useMemo(
            () => [
                    ...
                    {
                        title: (<div className='text-center gradient-text'>{translate('menus.code')}</div>),
                    ...
                    {
                        title: (<div className='text-center gradient-text'>{translate('menus.name')}</div>),
                    ...
                    {
                        title: (<div className='text-center gradient-text'>{translate('menus.path')}</div>),
                    ...
                    {
                        title: (<div className='text-center gradient-text'>{translate('menus.isDeleted')}</div>),
                        ...
                        render(id: number, menu: Menu) {
                            return (
                                <div className='d-flex justify-content-center button-action-table'>
                                    <Dropdown overlay={menuAction(id, menu)} trigger={["click"]} placement="bottomCenter" arrow>
