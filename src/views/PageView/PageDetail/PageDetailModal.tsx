...
interface PageDetailModalProps extends ModalProps {
  model: Page;
  ...
  dispatchModel?: React.Dispatch<FormDetailAction<Page>>;
  loading?: boolean;
}

function PageDetailModal(props: PageDetailModalProps) {
