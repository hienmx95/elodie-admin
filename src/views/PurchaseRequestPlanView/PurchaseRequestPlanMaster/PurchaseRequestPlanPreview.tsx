...
} from "../PurchaseRequestPlanDetail/PurchaseRequestPlanDetailHook/PurchaseRequestPlanFileMappingHook";
/* end individual import */

function PurchaseRequestPlanPreview() {
          ...
          return (
            <div className="table-cell__container">
              <div className="result-cell">
                <span className="cell-number">{params[0].level}</span>
              </div>
            </div>
          );
        },
...
export default PurchaseRequestPlanPreview;
