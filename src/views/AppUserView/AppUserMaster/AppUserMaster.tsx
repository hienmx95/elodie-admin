...
import AppUserRoleMappingView, { appUserRoleMappingHook } from "./AppUserRoleMappingHook";

/* end individual import */

function AppUserMaster() {
    const [translate] = useTranslation();
    const { validAction } = authenticationService.useAction('appUser', API_APP_USER_PREFIX);
                ...
                render(...params: [string, AppUser, number]) {
                    return (
                        <div className="button-hover">
                            {params[0] &&
                                <img src={params[0]} className="image" alt="" />
                            }
                            {!params[0] && (
            ...
            <div className="search__container mt-4">
                <Row justify="space-between">
                    <Col lg={4} className='pr-4'>
                        ...
                        <AdvanceStringFilter value={master.filter[nameof(master.list[0].username)]["contain"]}
                    ...
                    <Col lg={4} className='pr-4'>
                        ...
                        <AdvanceStringFilter value={master.filter[nameof(master.list[0].displayName)]["contain"]}
                            onEnter={master.handleChangeFilter(
                                nameof(master.list[0].displayName),
                                'contain' as any,
                                StringFilter,
                    ...
                    <Col lg={4} className='pr-4'>
                        ...
                        <AdvanceStringFilter value={master.filter[nameof(master.list[0].email)]["contain"]}
                            onEnter={master.handleChangeFilter(
                                nameof(master.list[0].email),
                                'contain' as any,
                                StringFilter,
                    ...
                    <Col lg={4} className='pr-4'>
                        ...
                        <AdvanceStringFilter value={master.filter[nameof(master.list[0].phone)]["contain"]}
                            onEnter={master.handleChangeFilter(
                                nameof(master.list[0].phone),
                                'contain' as any,
                                StringFilter,
