  ...
  return (
    ...
    >
      <div className="page page__detail">
        <div className="w-100 ">
          <FormItem label={translate("products.variations.code")}>
            <InputText
              isMaterial={true}
              value={variation.code}
              placeHolder={translate("products.variations.placeholder.code")}
              className={"tio-pages_outlined mr-3"}
              onChange={handleChangeSimpleField(nameof(variation.code))}
            />
          </FormItem>

          <FormItem label={translate("products.variations.name")}>
            <InputText
              isMaterial={true}
