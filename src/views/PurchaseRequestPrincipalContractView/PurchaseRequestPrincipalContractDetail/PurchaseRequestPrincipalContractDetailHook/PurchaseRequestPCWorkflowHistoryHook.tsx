...
export function usePurchaseRequestPCWorkflowHistory(model: PurchaseRequestPrincipalContract) {
...
interface PurchaseRequestPCWorkflowHistoryModalProps {
    model: PurchaseRequestPrincipalContract,
    isOpen: boolean,
    handleCloseHistory: () => void,

}
export function PurchaseRequestPCWorkflowHistoryModal(props: PurchaseRequestPCWorkflowHistoryModalProps) {
        ...
        () => [
            {
                title: (
                    <div className="text-left gradient-text">
                        {translate("purchaseRequestPrincipalContracts.histories.appUser")}
                    </div>
                ),
...

            {
                title: (
                    <div className="text-left gradient-text">
                        {translate("purchaseRequestPrincipalContracts.histories.requestWorkflowAction")}
                    </div>
                ),
            ...
            },
            {
                title: (
                    <div className="text-left gradient-text">
                        {translate("purchaseRequestPrincipalContracts.histories.savedAt")}
                    </div>
                ),
                        ...
                        <div className="preview__header">
                            <div className="preview__header-info">
                                <div className="preview__header-text">
                                    <span className="preview__header-title mt-2">{translate('purchaseRequestPrincipalContracts.histories.title')}</span>
                                </div>
