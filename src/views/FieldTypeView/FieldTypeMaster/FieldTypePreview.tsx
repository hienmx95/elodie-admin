...
interface FieldTypePreviewProps<T extends Model>
    {
    previewModel?: T;
    ...
    function FieldTypePreview(props: FieldTypePreviewProps<FieldType>
        ) {
            ...
            <Modal title={null}
                ...
                <div className="preview__containter">
                        ...
                        <div className="preview__header">
                            ...
                            <div className="preview__header-info">
                                <div className="preview__header-text">
                                    ...
                                    <span className="preview__header-date">{translate('fieldTypes.startDate')} { previewModel.startDate ? moment(previewModel.startDate).format('DD/MM/YYYY') : null }</span>
                                </div>
                        ...
                        <div className="preview__body">
                            <div className="preview__content">
                                <Descriptions title={previewModel.name} column={2}>
                                    <Descriptions.Item label={translate('fieldTypes.code')}>
                                        <span className="gradient-text">{ previewModel.code }</span>
                                    </Descriptions.Item>
                                    <Descriptions.Item label={translate('fieldTypes.name')}>
                    ...
                    <div className="preview__right-side">
                        {previewModel && <ChatBox getMessages={discussionRepository.list}
