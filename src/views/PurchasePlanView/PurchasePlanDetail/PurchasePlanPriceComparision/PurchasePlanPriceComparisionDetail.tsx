...
import "./PurchasePlanPriceComparisionDetail.scss";
import {
  PurchasePlanItemModal,
  usePurchasePlanItem,
} from "./PurchasePlanPriceComparisionHook/PurchasePlanItemHook";
...
export interface PurchasePlanPriceComparisionDetailProps {
...
function PurchasePlanPriceComparisionDetail(
  props: PurchasePlanPriceComparisionDetailProps
) {
          ...
          <Col lg={18} className="gutter-row">
            <div className="page__header d-flex align-items-center">
              ...
              <div className="page__header-go-back d-flex align-items-center">
                <div className="page__title mr-3">So sánh giá</div>
                {!isDetail && (
...
export default PurchasePlanPriceComparisionDetail;
