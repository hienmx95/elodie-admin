...
import "../PurchasePlanContractorAppointment/PurchasePlanContractorAppointmentApprove.scss";
import { useQuotation } from "./PurchasePlanContractorAppointmentHook/PurchasePlanApproveHook";
...
function PurchasePlanContractorAppointmentPreview() {
  ...
  const { childrenStep } = usePurchasePlanApproveFooter(
    translate,
    model,
    handleGoBase,
    handleOpenHistory
  ...
  const childrenStepCancel = React.useMemo(() => {
    return (
      <div className="d-flex justify-content-between">
        <Steps current={1} size="small" status="error" className="step-cancel">
  ...
  >[] = React.useMemo(() => {
    return [
      ...
      },
      {
        ...
        width: 200,
        key: nameof(model.purchasePlanContents[0].unitOfMeasure),
        dataIndex: nameof(model.purchasePlanContents[0].unitOfMeasure),
  ...
  return (
    <>
                ...
                >
                  <Row gutter={{ xs: 8, sm: 16, md: 24, lg: 32 }}>
                    ...
                    <Col lg={8} className="gutter-row mt-3">
                      ...
                      >
                        <span>{model?.reasonToChooseSupplier}</span>
                      </FormItem>
                    </Col>
                    <Col lg={8} className="gutter-row mt-3">
                      <FormItem
      ...
      <AppFooter
        ...
        childrenStep={
          model?.purchasePlanStatusId === 5 ? childrenStepCancel : childrenStep
        }
      ></AppFooter>
      <FileMappingModal
...
export default PurchasePlanContractorAppointmentPreview;
