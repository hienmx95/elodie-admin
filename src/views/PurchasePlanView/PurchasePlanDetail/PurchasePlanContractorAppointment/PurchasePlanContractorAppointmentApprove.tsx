...
import "./PurchasePlanContractorAppointmentApprove.scss";
...
function PurchasePlanContractorAppointmentApprove() {
...
export default PurchasePlanContractorAppointmentApprove;
