...
import {
  useComparision,
  useQuotation,
} from "./PurchasePlanContractorAppointmentHook/PurchasePlanApproveHook";
import "./PurchasePlanContractorAppointmentWaiting.scss";
...
function PurchasePlanContractorAppointmentWaiting() {
  ...
  }, [loadingSupplier, model, supplierFilter]);
                  ...
                  <Row>
                    <Col lg={7} className="gutter-row row-supplier pl-3 pr-3">
                      <div className="row-supplier_container">
                        ...
                        {model?.purchasePlanStatusId !== 4 && (
                          <button
                            className="btn btn__redo mt-3"
                            onClick={handleOpenConfirmRedoSupplier}
                          >
                            <span>
...
export default PurchasePlanContractorAppointmentWaiting;
