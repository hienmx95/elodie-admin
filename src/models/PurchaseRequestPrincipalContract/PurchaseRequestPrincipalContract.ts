...
export class PurchaseRequestPrincipalContract extends Model
{
    public id?: number;
    ...
    public categoryAncestors?: Category[];
    ...
    public requestOrganizationName?: string;

    public requestorPhoneNumber?: string;
